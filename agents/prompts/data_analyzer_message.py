...
6. If the user asks for a graph or plot, make sure to save it as `.png` with speicific name related to the topic in the current working directory.
7. if the user asks for a filter table rows , make sure to filter out rows according to user and save it as `.csv` with specific name related to the topic  in the current working directory
